...
UrbanNav is a large-scale urban navigation dataset automatically constructed using VLM based on web data, comprising 47k trajectories and 3M language instructions. Based on this dataset, we train language-conditioned navigation models designed for complex and dynamic outdoor scenarios. Our approach is deployed on a four-wheel differential-drive robot and validated in challenging and diverse outdoor urban environments.
![](src/overview.png)
